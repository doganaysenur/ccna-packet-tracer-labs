...
* **Routing (Yönlendirme):** Static Routing, Default Routing, RIP, EIGRP, OSPF (Single & Multi-area)
* **Switching & VLAN:** VLAN Configuration, Inter-VLAN Routing (Router-on-a-Stick), EtherChannel
* **Network Services & Security:** DHCP & DHCP Relay, NAT/PAT, Standard ACL, Extended ACL, HSRP, Telnet Configuration
